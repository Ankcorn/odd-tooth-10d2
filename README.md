...
```
npm create cloudflare@latest -- --template=cloudflare/templates/odd-tooth-10d2
```

A live public deployment of this template is available at [https://odd-tooth-10d2.templates.workers.dev](https://odd-tooth-10d2.templates.workers.dev)
